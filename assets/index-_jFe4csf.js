...
`)}function E(e,t){const i=document.createElement("div");return i.className="side-panel"+(t.meta?.variant==="right"?" right-panel":""),i.innerHTML=`
  ...
  `,t.appendChild(a);const n=document.createElement("div");n.className="main-grid";const s=u(e,"#panel-left");s&&n.appendChild(E(e,s));const o=document.createElement("div");o.className="center-col";const r=e.elements.filter(c=>c.type==="container"&&c.containerType==="layer").map(c=>c).sort((c,d)=>(d.meta?.order??0)-(c.meta?.order??0)),p=e.elements.filter(c=>c.type==="container"&&c.containerType==="pipeline").map(c=>c),g=[...r,...p].sort((c,d)=>(d.meta?.order??0)-(c.meta?.order??0));for(const c of g)o.appendChild(de(e,c));n.appendChild(o);const v=u(e,"#panel-right");if(v&&n.appendChild(E(e,v)),t.appendChild(n),e.legend.show&&e.badges.length>0){const c=document.createElement("div");c.className="legend";const d=e.badges.map(m=>`
  ...
  `}function ve(e,t){return`<button class="info-badge" data-overlay-target="${t}" type="button" aria-expanded="false">ⓘ ${e}</button>`}function ye(e,t){return`<div class="info-overlay" id="${e}" hidden role="dialog" aria-modal="true">
    ...
    </div>`}).join("")}function $e(e,t){const i=e.elements.find(m=>m.id===t),a=document.createElement("div");if(a.className="detail-view",!i)return a.innerHTML=`
    ...
    `,a;const n=i.type==="container"?i.children:[],s=i.description||"",o=we(e,t),r=fe(e,t);if(i.id==="#L9"&&i.type==="container")return a.innerHTML=`
      ...
      ${le(e,i)}
      ${r}
    `,a;const p=i.type==="item"&&i.itemType==="participant"?i:null,g=p?Ie(e,p):"",v=p?Ae(e,p):"",l=n.length>0?`<div class="detail-items">${N(e,n)}</div>`:s?"":'<div class="detail-items"><div class="detail-item detail-item--empty">No sub-elements</div></div>',c=p?.role?ve("EU AI Act context","overlay-eu-ai-act"):"",d=p?.role?ye("overlay-eu-ai-act",ge(p.role)):"";return a.innerHTML=`
    ${o}
    ...
    ${l}
    ${r}
  `,p?.role&&_e(a),a}function ke(){const e=document.createElement("div");return e.className="page-view",e.innerHTML=`
  ...
  `,e}function Ce(){const e=document.createElement("div");return e.className="page-view",e.innerHTML=`
    <div class="page-view__hero">
  ...
  `,e}function Oe(){const e=document.createElement("div");return e.className="page-view",e.innerHTML=`
    <div class="page-view__content">
  ...
  `,e}const Ee=[{href:"#/",label:"OIA",route:"/"},{href:"#/motivation",label:"Motivation",route:"/motivation"},{href:"#/contribute",label:"Contribute",route:"/contribute"},{href:"#/about",label:"About",route:"/about"},{href:"#/legal",label:"Legal Notice",route:"/legal"}];function xe(e){return e.startsWith("#/motivation")?"/motivation":e.startsWith("#/contribute")?"/contribute":e.startsWith("#/about")?"/about":e.startsWith("#/legal")?"/legal":"/"}function ze(e){const t=xe(window.location.hash||"#/");e.innerHTML=`
  ...
  `}const Se=.75,k=.4,x=1,I=.05,Pe=.55,Re=.75;let C,y,A=null;const Me=1440;function Ne(){return Math.max(k,Math.min(Se,window.innerWidth/Me))}let _=Ne();function $(e){_=e;const t=y.querySelector(".diagram-wrapper");if(t){t.style.transform=`scale(${_})`;const n=_<Pe?"zoom-far":_<Re?"zoom-mid":"zoom-full";t.classList.remove("zoom-far","zoom-mid","zoom-full"),t.classList.add(n)}const i=y.querySelector(".zoom-label");i&&(i.textContent=Math.round(_*100)+"%");const a=y.querySelector(".zoom-slider");a&&(a.value=String(_*100))}function H(){y.querySelectorAll("[data-id]").forEach(e=>{e.addEventListener("click",t=>{t.stopPropagation();const i=e.dataset.id;i&&(window.location.hash=`#/detail/${i}`)})})}function He(){y.innerHTML="";const e=me(C);y.appendChild(e),$(_),H();const t=document.createElement("div");t.className="zoom-controls",t.innerHTML=`
    <span class="zoom-controls__label">Zoom</span>
    <input class="zoom-slider" type="range" min="${k*100}" max="${x*100}" value="${Math.round(_*100)}" step="${I*100}">
    <span class="zoom-label">${Math.round(_*100)}%</span>
  `,y.appendChild(t);const i=t.querySelector(".zoom-slider");i.addEventListener("input",()=>$(Number(i.value)/100)),t.addEventListener("wheel",a=>{a.preventDefault();const n=a.deltaY<0?I:-I;$(Math.min(x,Math.max(k,_+n)))})}function je(e){y.innerHTML="",y.appendChild($e(C,e)),H()}function w(e){y.innerHTML="",y.appendChild(e)}function Be(e,t){C=e,y=t,A=document.getElementById("site-nav");const i=document.querySelector(".github-fab"),a=()=>{const n=window.location.hash||"#/";A&&ze(A);const s=n==="#/motivation"||n==="#/contribute"||n==="#/about"||n==="#/legal";i&&(i.style.display=s?"":"none"),n.startsWith("#/detail/")?je(decodeURIComponent(n.replace("#/detail/",""))):n==="#/motivation"?w(ke()):n==="#/contribute"?w(Ce()):n==="#/about"?w(Oe()):n==="#/legal"?w(De()):He()};window.addEventListener("hashchange",a),a()}const Ke=document.getElementById("app");Be(q,Ke);
